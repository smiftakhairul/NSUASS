...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('appointmentReports.index') }}">Appointment Reports</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('appointmentReports.today') }}" class="current">Today</a></div>
		{{-- <h1>Visitors</h1> --}}
	</div>
			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						@if($reports->isEmpty())
							<div class="alert alert-warning">No appointment today!</div>
						@else
