		...
		<div class="row-fluid">
			<div class="span12">
				<div class="text-right">
					<a href="{{ route('appointments.approved') }}" class="btn btn-success btn-mini">Approved</a>
					<a href="{{ route('appointments.pending') }}" class="btn btn-warning btn-mini">Pending</a>
					<a href="{{ route('appointments.rejected') }}" class="btn btn-inverse btn-mini">Rejected</a>
				</div>
