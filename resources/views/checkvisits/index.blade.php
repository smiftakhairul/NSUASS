			...
			<div class="span6 offset3">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="{{ route('checkVisits.check') }}" method="POST" class="form-horizontal">
							...
							<div class="control-group">
								<label class="control-label">Enter Visit Access Code :</label>
								<div class="controls">
									<input type="text" class="span11" name="code" placeholder="Access code" required>
									@if($errors->has('code'))
									<li class="error">{{ $errors->first('code') }}</li>
									@endif
									<span class="help-block">Access code is provided in Visit Card</span>
								</div>
							</div>
