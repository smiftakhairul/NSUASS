...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('immediatevisits.index') }}" class="tip-bottom">Immediate Visits</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('immediatevisits.create') }}" class="current">Create</a></div>
			...
			<div class="span6 offset3">
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"> <i class="fa fa-align-justify" aria-hidden="true"></i> </span>
						<h5>Immediate Visit Form</h5>
					</div>
					<div class="widget-content nopadding">
						<form action="{{ route('immediatevisits.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
							{{ csrf_field() }}
