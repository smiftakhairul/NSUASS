...
@section('title', 'Manage Appointments Requests')

@section('body')

<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('manageappointments.index') }}" class="current">Appointment Requests</a></div>
		{{-- <h1>Visitors</h1> --}}
	</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="text-right">
					<a href="{{ route('manageappointments.approved') }}" class="btn btn-success btn-mini">Approved</a>
					<a href="{{ route('manageappointments.pending') }}" class="btn btn-warning btn-mini">Pending</a>
					<a href="{{ route('manageappointments.rejected') }}" class="btn btn-inverse btn-mini">Rejected</a>
				</div>
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						@if($appointments->isEmpty())
							<div class="alert alert-warning">No appointment requests found!</div>
						@else
