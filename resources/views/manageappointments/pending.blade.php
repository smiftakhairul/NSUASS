				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						@if($appointments->isEmpty())
							<div class="alert alert-warning">No pending appointment requests found!</div>
						@else
