			...
			<div class="span12">
				...
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"><i class="fa fa-th"></i></span>
						<h5>Approved Visit Requests</h5>
					</div>

					<div class="widget-content nopadding">
						@if($visits->isEmpty())
							<div class="alert alert-warning">No approved visit requests found!</div>
						@else
