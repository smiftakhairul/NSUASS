...
@section('title', 'Manage Visit Requests')

@section('body')

<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('managevisits.index') }}" class="current">Visit Requests</a></div>
		{{-- <h1>Visitors</h1> --}}
	</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="text-right">
					<a href="{{ route('managevisits.approved') }}" class="btn btn-success btn-mini">Approved</a>
					<a href="{{ route('managevisits.pending') }}" class="btn btn-warning btn-mini">Pending</a>
					<a href="{{ route('managevisits.rejected') }}" class="btn btn-inverse btn-mini">Rejected</a>
				</div>
