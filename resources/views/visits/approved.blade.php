...
@section('title', 'Approved Visit Requests')

@section('body')

<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('visits.index') }}" >My Visit Requests</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('visits.approved') }}" class="current">Approved</a></div>
		{{-- <h1>Visitors</h1> --}}
	</div>
			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						@if($visits->isEmpty())
							<div class="alert alert-warning">No visit requests approved!</div>
						@else
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a class="btn btn-info btn-mini" href="{{ route('visitDownload', $visit->id) }}"><i class="fa fa-download" aria-hidden="true"></i></a>
