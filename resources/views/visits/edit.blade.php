...
@section('title', 'Edit Visit Request')
...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Dashboard" class="tip-bottom"><i class="fa fa-home" aria-hidden="true"></i> Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('visits.index') }}" class="tip-bottom">Visit Requests</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ route('visits.edit', $visit->id) }}" class="current">Edit</a></div>
			...
			<div class="span8 offset2">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="{{ route('visits.update', $visit->id) }}" method="POST" class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="vDate" name="vDate" placeholder="Pick date" value="{{ $visit->vDate }}" required>
									@if($errors->has('vDate'))
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="vTime" name="vTime" placeholder="Pick time" value="{{ $visit->vTime }}" required>
									@if($errors->has('vTime'))
							...
							<div class="control-group">
								...
								<div class="controls">
									<textarea class="span11" name="purpose" cols="30" rows="7" required>{{ $visit->purpose }}</textarea>
