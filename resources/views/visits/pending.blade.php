			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						@if($visits->isEmpty())
							<div class="alert alert-warning">No visit requests pending!</div>
						@else
